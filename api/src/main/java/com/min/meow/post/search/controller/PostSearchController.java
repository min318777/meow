...
public class PostSearchController {
    ...
    @PostMapping("/search")
    public ResponseEntity<ApiResponse<Page<BoastCatPostListResponse>>> search(
        ...
        Page<BoastCatPostListResponse> posts = postSearchService.search(postSearchRequest, pageable);
